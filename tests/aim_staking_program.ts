...
describe("aim_staking_program", () => {
  ...
  // The secret key must be a 64-byte array.
  const feeWallet = anchor.web3.Keypair.fromSecretKey(
    Uint8Array.from([146,102,217,213,107,241,153,131,114,187,14,15,203,76,170,81,13,7,246,92,20,106,21,23,16,10,183,133,222,102,191,12,12,234,152,196,12,117,100,24,21,169,118,14,136,125,142,14,125,21,115,248,132,192,155,12,24,222,115,182,17,13,23,19])
  );
